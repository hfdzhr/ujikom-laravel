...
Route::get('/data/product', [\App\Http\Controllers\API\ProductController::class, 'index']);
Route::get('/data/product/{slug}', [\App\Http\Controllers\API\ProductController::class, 'show']);
