                    ...
                    <div class="container-fluid">
                        <div class="furniture-bottom-wrapper">
                            <div class="furniture-login">
                                <ul>
                                    @guest
                                        <li>Akun: <a href="{{ route('login') }}">Login</a></li>
                            ...
                            <div class="furniture-search">
                                <form>
                                    <input placeholder="Cari Produk . . ." type="text" name="q" autocomplete="off" id="search">
                                    <button disabled>
                                        <i class="ti-search"></i>
                                    </button>
                                </form>
                    ...
                    <div class="widget-wrapper">
                        ...
                        <h4>QuickGrocer</h4>
                            <div class="footer-about-2">
                                <p>QuickGrocer adalah sebuah aplikasi belanja online grosir <br> yang mempermudah anda dalam mencari <br> produk grosir</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Jl. Ciodeng Andir, Komp. wkwk <br>40238, Indonesia</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                ...
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#">email@quickgrocer.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="/">Hafid Al Azhar</a> 2024 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
